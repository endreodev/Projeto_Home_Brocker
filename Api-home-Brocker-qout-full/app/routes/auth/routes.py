...
from app.models.models import Empresa, User, Acessos
...
def init_routes(app):
    ...
    def login():
        ...
        if user and check_password_hash(user.password, password):
            ...
            print(f"login com usuario  { user.email} : empresa id { user.empresa_id }")
            empresas = Empresa.query.get(user.empresa_id)
            integra_skn = empresas.integra_skn
            ...
            additional_claims = {
                ...
                'integracao_sankhya':integra_skn ,
            ...
            if not empresa.logomarca: 
                image_url = request.host_url + 'uploads/notfound.png'
            else: 
                image_url = request.host_url + 'uploads/' + empresa.logomarca
