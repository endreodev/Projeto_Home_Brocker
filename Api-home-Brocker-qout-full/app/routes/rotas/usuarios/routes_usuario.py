...
def init_routes_usuario(app):
    ...
    #auterar a senha 
    @app.route('/change-password-user', methods=['POST'])
    @jwt_required()
    def change_password_user():
        ...
        user_id_alterar = data.get('user_id')
        new_password = data.get('new_password')
        ...
        # Atualiza a senha com uma nova senha hasheada
        usuario_alt = User.query.get(user_id_alterar)
        usuario_alt.password = generate_password_hash(new_password)
        db.session.commit()
